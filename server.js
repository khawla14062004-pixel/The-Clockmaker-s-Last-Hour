    ...
    io.to(code).emit("game_over", {
      ...
      results: {
        player1: match.players.player1
          ? { finished: match.players.player1.finished, finishTime: match.players.player1.finishTime }
          : null,
        player2: match.players.player2
          ? { finished: match.players.player2.finished, finishTime: match.players.player2.finishTime }
          : null
      }
    });
  });
